...
async function main() {
  ...
  writeFileSync(__dirname + "/../dist/ncc/main.ts.cache", indexAssets["main.ts.cache"].source);
  ...
  writeFileSync(__dirname + "/../dist/ncc/main.ts.cache.js", indexAssets["main.ts.cache.js"].source);
  ...
  writeFileSync(__dirname + "/../dist/ncc/main.ts", index);
